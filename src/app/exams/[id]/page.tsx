    ...
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 py-5 md:px-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          <div className={`flex flex-col gap-6 ${isChooseImages ? "lg:col-span-7 lg:order-1" : "lg:col-span-9 lg:order-1"}`}>
          ...
          <div className={`flex flex-col gap-6 ${isChooseImages ? "lg:col-span-5 lg:order-2" : "lg:col-span-3 lg:order-2"}`}>
            {isChooseImages ? (
