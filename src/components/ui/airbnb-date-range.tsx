    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <>
          ...
          <div className="fixed inset-x-0 bottom-16 z-50 sm:absolute sm:inset-auto sm:top-full sm:right-0 sm:mt-3 sm:w-fit bg-surface-container-lowest sm:rounded-3xl rounded-t-3xl shadow-[0_-8px_40px_rgba(0,0,0,0.15)] border border-outline-variant/20 sm:p-8 p-5 sm:max-w-none max-h-[70vh] overflow-y-auto">
